...
<head>
	<?php
		...
		$l_name = $row['l_name'];
	?>
	<title><?php echo "$f_name $l_name Profile"; ?></title>
	<meta charset="utf-8">
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #fcecec;text-align: center;left: 0.7%;border-radius: 5px;margin-right:20px;border:3px solid #e38116;">
		<?php
		echo"
			<div id='aboutMe'>
			...
			<p><strong>Job Field: </strong> $job_field</p><br> 
	...
	<div class="col-sm-6">
	<div id="insert_post1" class="col-sm-12">
		<center>
		<form action="profile.php?id=<?php echo $user_id; ?>" method="post" id="f" enctype="multipart/form-data">
		<textarea class="form-control" id="content" rows="4" name="content" placeholder="What's in your mind?" style="resize: none;" required></textarea><br>
